...
export default function ShowParking({ parking, isPremium, isOwner }: Props) {
                    ...
                    {isOwner && (
                        <div className="flex gap-2">
                            <Button
                                ...
                                onClick={() =>
                                    router.post(`/parkings/${parking.id}/toggle-status`)
                                }
                            >
                                {parking.status === 'active' ? (
                                    <>
                            ...
                            <Button
                                size="sm"
                                onClick={() =>
                                    router.visit(`/parkings/${parking.id}/edit`)
                                }
                            >
                ...
                <div className="mt-6 grid grid-cols-4 gap-4">
                    ...
                    <div className="rounded-lg border p-4 text-center">
                        <p className="text-2xl font-bold text-yellow-600">
                            {isNaN(price) ? '0.00' : price.toFixed(2)} TND
                        </p>
